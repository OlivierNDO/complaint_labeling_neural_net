...
#np.save(config.config_train_x_save_name, train_sequences)
#np.save(config.config_test_x_save_name, test_sequences)
#np.save(config.config_train_y_save_name, train_y)
#np.save(config.config_test_y_save_name, test_y)
...
def bidirectional_lstm_classifier_compiled(input_dim, output_dim, input_length, n_classes, word_index,
                                           dropout_rate = 0.2, lr = 0.0001, loss = 'categorical_crossentropy',
