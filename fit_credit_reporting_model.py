...
### Credit Reporting Complaint Categorization Model
########################################################################################################
...
# Fit Model
cr_model = m.cudnn_lstm_classifier(input_dim = train_x.shape[1],
                                   output_dim = 100,
                                   input_length = train_x.shape[1],
                                   n_classes = train_y.shape[1],
                                   word_index = cr_pipeline.get_tokenizer_word_index())

cr_classifier = m.RNNClassificationTrainer(model = cr_model,
                                           train_x = train_x,
                                           train_y = train_y,
                                           valid_x = valid_x,
                                           valid_y = valid_y,
