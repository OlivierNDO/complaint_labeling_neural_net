...
product_pipeline = tp.TextProcessingPipeline(string_list = None, test_string_list = None,
...
train_x, train_y, valid_x, valid_y, test_x, test_y = product_pipeline.load_transformed_train_test_valid_data()
